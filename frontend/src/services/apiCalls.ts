...
const validationUrl = endpointUrl + "/auth/register/validation";
const loginUrl = endpointUrl + "/auth/login";
const createCodeUrl = endpointUrl + "/admin/invite";
...
export const authApi = {
  createRegistrationCode: async (
    ...
    const response = await axios.post<registrationReturn>(
      createCodeUrl,
      registration,
    );
    return response.data;
