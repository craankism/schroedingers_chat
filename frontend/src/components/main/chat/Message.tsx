      ...
      {!announcement && showAiHint && (
        ...
        >
          <Typography variant="caption" color="text.secondary">
            Ask our Artificial Meowligence 🐈‍⬛ with{" "}
            <Box component="strong">@void</Box> · Use the paperclip to add a
            file reference for Void
          </Typography>
        </Box>
      )}
      ...
      >
        ...
        {selectedFile && (
          <Chip
            ...
            onDelete={setSelectedFile ? () => setSelectedFile(null) : undefined}
            size="small"
            icon={<AttachFile />}
            sx={{
              gridColumn: 2,
